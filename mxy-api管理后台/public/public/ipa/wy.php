...
<?php echo $key; ?>/api/wy.php
</a><br/>
参数：<br/>
<li>msg (必填)<dr/>type （选填）xml可以返回xml数据<dr/>n （选填）
</li>
备注：<br/>
暂无<br/>
<hr>
...
<?php echo $key; ?>/api/wy.php?msg=<?php echo $mz; ?>&n=1
</a>
<hr>
<br/>
返回数据：<br/>
<div style="width:100%;background-color: #000;background-image: linear-gradient(90deg, #6694ed 0%,);color:#FFFFFF;border-radius:5px">
图片：http://p1.music.126.net/e8fH2UsfeY-DEDpxVWsnGw==/109951163031105466.jpg歌名：<?php echo $mz; ?> 歌手：杨卿俪 播放链接：http://music.163.com/song/media/outer/url?id=508917356
</h3>
</div>
<hr>
</div>
