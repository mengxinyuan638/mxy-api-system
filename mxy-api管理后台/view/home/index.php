...
<body class="layui-layout-body pear-admin">
	...
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-header">
			...
			<ul class="layui-nav layui-layout-right">
				...
				<li class="layui-nav-item layui-hide-xs"><a href="https://api.juncikeji.xyz" class="layui-icon layui-icon-website"></a></li>
	...
	<!-- 框 架 初 始 化 -->
	<script>
		layui.use(['admin', 'jquery', 'popup', 'drawer', 'layer'], function() {
			var $ = layui.jquery;
			var admin = layui.admin;
			var popup = layui.popup;
			var layer = layui.layer

			$.post("/index/version", function(d) {

				admin.setConfigType("yml");
				admin.setConfigPath("/config/pear.config.yml");
				admin.render();
				layer.alert('欢迎使用萌新源API管理系统'+d, {
					icon: 6
				});
