...
<?php echo $key; ?>/api/cyjl.php
</a><br/>
参数：<br/>
<li>msg 开始成语接龙或者我接+成语（必填）
</li>
备注：<br/>
暂无<br/>
<hr>
...
<?php echo $key; ?>/api/cyjl.php?msg=开始成语接龙慕&id=1984873728
</a>
<hr>
<br/>
返回数据：<br/>
<div style="width:100%;background-color: #000;background-image: linear-gradient(90deg, #6694ed 0%,);color:#FFFFFF;border-radius:5px">
开始咯！本宝宝出题啦！ 成语：趋炎慕势 拼音：qū yán mù shì 解释：趋：奔走，投靠；炎：热。奉承和依附有权有势的人。 请接以〖势〗字的成语。
</h3>
</div>
<hr>
</div>
