...
<?php echo $key; ?>/api/qqdz.php?msg=<?php echo $mz; ?>&n=1
</a>
<hr>
<br/>
返回数据：<br/>
<div style="width:100%;background-color: #000;background-image: linear-gradient(90deg, #6694ed 0%,);color:#FFFFFF;border-radius:5px">
搞笑段子：秀恩爱的最新方式，没有一点臂力是做不到的！兄弟们都该锻炼下了！\n[img:url="http://qqpublic.qpic.cn/qq_public/0/0-3024218768-2350D7376B433179963B25D43D9DF9D9/0?fmt=gif\u0026size=2003\u0026h=360\u0026w=292\u0026ppv=1"]\n神评：那待看媳妇轻不轻了\u0014AO
</h3>
</div>
<hr>
</div>
