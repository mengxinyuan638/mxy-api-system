...
<?php echo $key; ?>/api/kugoudx.php
</a><br/>
参数：<br/>
<li>msg （必填）<br/>type （选填）type为xml时将输出xml格式<br/>n （选择时必填）
</li>
备注：<br/>
暂无<br/>
<hr>
...
<?php echo $key; ?>/api/kugoudx.php?msg=呵呵&n=1
</a>
<hr>
<br/>
返回数据：<br/>
<div style="width:100%;background-color: #000;background-image: linear-gradient(90deg, #6694ed 0%,);color:#FFFFFF;border-radius:5px">
歌曲：呵呵歌手：没事干装什么逗逼播放链接：http://fs.pc.kugou.com/201912211521/cd4baf530f01370d07c7666d2295ec17/G049/M0A/1F/01/cQ0DAFYd_SWIB0-MAAILAAB41cgAAAL6ABcofcAAgsY320.m4a
</h3>
</div>
<hr>
</div>
